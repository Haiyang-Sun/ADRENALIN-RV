...
public class NetworkDiSLClass {
	...
	public static void sendto(final ArgumentProcessorContext apc,
		...
		DataLeakMonitorState.addEvent(new NetworkSinkEvent(dsc
	...
	public static void sendto_bytebuffer(final ArgumentProcessorContext apc,
			final DexStaticContext dsc) {
		final Object[] args = apc.getArgs(ArgumentProcessorMode.METHOD_ARGS);
		final FileDescriptor fd = (FileDescriptor) args[0];
